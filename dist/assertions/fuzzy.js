...
exports.assertFuzzyMatch = assertFuzzyMatch;
exports.assertContains = assertContains;
exports.assertMatches = assertMatches;
exports.assertApproximately = assertApproximately;
exports.assertArrayContains = assertArrayContains;
exports.assertObjectContains = assertObjectContains;
 ...
 */
function assertFuzzyMatch(actual, expected, opts = {}) {
 ...
 */
function assertContains(actual, expected, opts = {}) {
    const a = normalize(actual, opts);
    const e = normalize(expected, opts);
 ...
 */
function assertMatches(actual, pattern) {
